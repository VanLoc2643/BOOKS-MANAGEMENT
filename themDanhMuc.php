    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid" class >
                ...
                <form action="xulyDanhMuc.php" method="POST">
                    <label for="tentheloai" class="form-label">Tên Thể Loại:</label>
                    <input type="text"  name="tentheloai" class="form-input" value="" required >

                    <button type="submit" class="form-button" name ="xacnhandanhmuc">Xác Nhận</button>
                </form>
